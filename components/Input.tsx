      ...
      {kind === "price" && (
        <div className="rounded-md relative flex  items-center shadow-sm">
          ...
          <input
            ...
            type={type}
            placeholder={placeholder}
            className="appearance-none pl-7 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 placeholder:text-red-300 placeholder:text-sm"
          />
